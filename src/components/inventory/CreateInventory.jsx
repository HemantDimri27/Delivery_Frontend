...
const CreateInventory = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post('/api/delivery/createInventory', formData , { headers: {Authorization: `Bearer ${token}`}});
      ...
      <div style={styles.formContainer}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.formGroup}>
            ...
            <input style={styles.input} type="number" id="capacity" placeholder="Enter your capacity" name="capacity" value={formData.capacity} onChange={handleChange} required />
          </div>
          <div style={styles.formGroup}>
            <label style={styles.label} htmlFor="address">Address</label>
            <input style={styles.input} type="text" id="address" placeholder="Enter your address" name="address" value={formData.address} onChange={handleChange} ref={addressInputRef} required />
          </div>
