  ...
  return (
    <div style={styles.body}>
      <div style={styles.formContainer}>
        <h2 style={styles.formTitle}>Update Inventory</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.formGroup}>
            ...
            <input style={styles.input} type="number" id="capacity" placeholder="Enter your capacity" name="capacity" value={formData.capacity} onChange={handleChange} />
          </div>
          <div style={styles.formGroup}>
